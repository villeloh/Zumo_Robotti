...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the SDA_2_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(SDA_2__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in SDA_2_SetInterruptMode() function.
     *  @{
     */
        #define SDA_2_INTR_NONE      (uint16)(0x0000u)
        #define SDA_2_INTR_RISING    (uint16)(0x0001u)
        #define SDA_2_INTR_FALLING   (uint16)(0x0002u)
        #define SDA_2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define SDA_2_INTR_MASK      (0x01u) 
#endif /* (SDA_2__INTSTAT) */
...
/* SIO registers */
#if defined(SDA_2__SIO_CFG)
    #define SDA_2_SIO_HYST_EN        (* (reg8 *) SDA_2__SIO_HYST_EN)
    #define SDA_2_SIO_REG_HIFREQ     (* (reg8 *) SDA_2__SIO_REG_HIFREQ)
    #define SDA_2_SIO_CFG            (* (reg8 *) SDA_2__SIO_CFG)
    #define SDA_2_SIO_DIFF           (* (reg8 *) SDA_2__SIO_DIFF)
#endif /* (SDA_2__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define SDA_2_0_INTTYPE_REG 		(* (reg8 *) SDA_2__0__INTTYPE)
#endif /* (SDA_2__INTSTAT) */
