    ...
    {    
        ...
        { 
            ...
            do {
                ...
                if (norm_blackness_2 > black_threshold) { norm_blackness_2 = black_threshold;}
                ...
                turn = 2.5 * speed * ( (black_threshold - norm_blackness_2) / black_threshold );
                ...
                turn += 60 * powf((black_threshold / blackness_2), 2.0); // max effect on turn is ~+180 (with a norm_blackness_2 <= 10000). with 20 000, turn += 45.
